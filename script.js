...
const translations = {
  en: {
    ...
    currently_building: 'Currently building: Synapkey',
    ...
    btn_try:      'Try it Live',
    synapkey_desc:
      "A Firebase-powered platform with realtime database, Firestore and custom " +
      "security rules currently in active development.",
  ...
  de: {
    ...
    currently_building: 'Aktuell in Arbeit: Synapkey',
    ...
    synapkey_desc:
      "Eine Firebase-basierte Plattform mit Realtime Database, Firestore und eigenen " +
      "Security Rules aktuell in aktiver Entwicklung.",
...
if (profilePhoto.complete && profilePhoto.naturalWidth > 0) {
  ...
  profilePhoto.addEventListener('load', () => profilePhoto.classList.add('loaded'));
}
